...
ANALYSIS_STATISTICS := $(addprefix $(ANALYSIS_STATISTICS_DIR)/, \
		$(shell echo {all,sl}-{thompson,flat}-{mfn,cn,in,none}.tex))
...
ANALYSIS_STEP_ALL := $(addprefix $(ANALYSIS_STEP_DIR)/all-, \
		$(shell echo {full,partial}-{thompson,flat}-spencer-{mfn,cn,in,none}.tex) \
...
ANALYSIS_MEMO_SIZE_ALL := $(addprefix $(ANALYSIS_MEMO_SIZE_DIR)/all-, \
		$(shell echo {full,partial}-{thompson,flat}-spencer-{mfn,cn,in}.tex))
